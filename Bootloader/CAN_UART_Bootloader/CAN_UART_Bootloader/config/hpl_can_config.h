...
#ifndef CONF_CAN1_MRCFG_RUNSTANDBY
#define CONF_CAN1_MRCFG_RUNSTANDBY 0
#endif
// </hidden>
...
#define CONF_CAN1_IE_DO 0
#endif

// </h>

#ifndef CONF_CAN1_CCCR_REG
#define CONF_CAN1_CCCR_REG (CONF_CAN1_CCCR_FDOE << CAN_CCCR_FDOE_Pos) | (CONF_CAN1_CCCR_BRSE << CAN_CCCR_BRSE_Pos)
#endif

#ifndef CONF_CAN1_MRCFG_REG
#define CONF_CAN1_MRCFG_REG CAN_MRCFG_QOS(CONF_CAN1_MRCFG_DQOS)
#endif

#ifndef CONF_CAN1_BTP_REG
#define CONF_CAN1_BTP_REG                                                                                              \
	CAN_NBTP_NBRP(CONF_CAN1_BTP_BRP - 1) | CAN_NBTP_NTSEG1(CONF_CAN1_BTP_TSEG1 - 1)                                    \
	    | CAN_NBTP_NTSEG2(CONF_CAN1_BTP_TSEG2 - 1) | CAN_NBTP_NSJW(CONF_CAN1_BTP_SJW - 1)
#endif

#ifndef CONF_CAN1_DBTP_REG
#define CONF_CAN1_DBTP_REG                                                                                             \
	(CONF_CAN1_DBTP_TDC << CAN_DBTP_TDC_Pos) | CAN_DBTP_DBRP(CONF_CAN1_DBTP_DBRP - 1)                                  \
	    | CAN_DBTP_DTSEG1(CONF_CAN1_DBTP_DTSEG1 - 1) | CAN_DBTP_DTSEG2(CONF_CAN1_DBTP_DTSEG2 - 1)                      \
	    | CAN_DBTP_DSJW(CONF_CAN1_DBTP_DSJW - 1)
#endif
...
#define CONF_CAN1_RXESC_REG CAN_RXESC_F0DS(CONF_CAN1_RXESC_F0DS)
#endif

#ifndef CONF_CAN1_TXESC_REG
#define CONF_CAN1_TXESC_REG CAN_TXESC_TBDS(CONF_CAN1_TXESC_TBDS)
#endif

#ifndef CONF_CAN1_TXBC_REG
#define CONF_CAN1_TXBC_REG CAN_TXBC_TFQS(CONF_CAN1_TXBC_TFQS)
#endif
...
#define CONF_CAN1_GFC_REG                                                                                              \
	CAN_GFC_ANFS(CONF_CAN1_GFC_ANFS) | CAN_GFC_ANFE(CONF_CAN1_GFC_ANFE) | (CONF_CAN1_GFC_RRFS << CAN_GFC_RRFS_Pos)     \
	    | (CONF_CAN1_GFC_RRFE << CAN_GFC_RRFE_Pos)
#endif

#ifndef CONF_CAN1_SIDFC_REG
#define CONF_CAN1_SIDFC_REG CAN_SIDFC_LSS(CONF_CAN1_SIDFC_LSS)
#endif

#ifndef CONF_CAN1_XIDFC_REG
#define CONF_CAN1_XIDFC_REG CAN_XIDFC_LSE(CONF_CAN1_XIDFC_LSS)
#endif

#ifndef CONF_CAN1_XIDAM_REG
#define CONF_CAN1_XIDAM_REG CAN_XIDAM_EIDM(CONF_CAN1_XIDAM_EIDM)
#endif

#ifndef CONF_CAN0_IE_REG
#define CONF_CAN0_IE_REG                                                                                               \
	(CONF_CAN1_IE_EW << CAN_IR_EW_Pos) | (CONF_CAN1_IE_EA << CAN_IR_EP_Pos) | (CONF_CAN1_IE_EP << CAN_IR_EP_Pos)       \
	    | (CONF_CAN1_IE_BO << CAN_IR_BO_Pos) | (CONF_CAN1_IE_DO << CAN_IR_RF0L_Pos)
#endif
